...
import 'package:rolodex/data/contacts.dart';
...
class _ContactListView extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final AlphabetizedContactMap contacts = contactGroupsModel.findContactList(listId).alphabetizedContacts;

    return CustomScrollView(
      slivers: [
        CupertinoSliverNavigationBar.search(
          largeTitle: Text(contactGroupsModel.findContactList(listId).title),
